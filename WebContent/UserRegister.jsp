...
<body>
<%-- <img src="${pageContext.request.contextPath}/images/blue.jpg" > --%>
<div class="c1">
 <form name="userregister" method="post">
        <table>
        <div><h2 style="margin-left:110px;margin-top:10px;";>用户注册</h2></div>
        
        <tr>
          <td><div>&nbsp;&nbsp;&nbsp;<span>*</span>用户：<input type="text" name="username" size="30"/></div></td>
        </tr>
        <tr>
          <td><div>&nbsp;&nbsp;&nbsp;<span>*</span>密码：<input type="password" name="password"  size="30"/></div></td>
        </tr>
        <tr>
          <td><div>&nbsp;&nbsp;&nbsp;<span>*</span>确认密码：<input style="margin-left:1px;" type="password" name="repassword"  size="30"/></div></td>
        </tr>
        <tr>
          <td><div>&nbsp;&nbsp;&nbsp;<span>*</span>E-mail：<input style="margin-left:14px;" type="password" name="password"  size="30"/></div></td>
        </tr>
        <tr>
          <td><div>&nbsp;&nbsp;&nbsp;&nbsp;姓名：<input type="text" name="name"  size="30"/></div></td>
        </tr>
        <tr>
          <td><div>&nbsp;&nbsp;&nbsp;&nbsp;电话：<input type="text" name="number"  size="30"/></div></td>
        </tr>
        <tr>
          <td><div>&nbsp;&nbsp;&nbsp;&nbsp;地址：<input type="text" name="address"  size="30"/></div></td>
        </tr>
        <tr>
          <td colspan="2"><input type="submit" value="同意以下协议并注册" style="color:white;font-size:17px; background-color:red;height:40px;"/></td>
        </tr>
...
<div class="c2">注册协议
<textarea style="margin-top:15px;" rows=25 cols=50>一、总则
1.1 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与保宝网之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。 
...
8.3 本协议解释权及修订权归深圳永兴元科技有限公司所有。 </textarea>
</div>
</body>
</html>